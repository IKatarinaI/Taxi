...
namespace Taxi
{
    public class WebApiApplication : System.Web.HttpApplication
    {
        ...
        {
            if (File.Exists(@"C:\Users\Katarina\Desktop\Taxi\Taxi\Taxi\Taxi\korisnici.xml"))
            {
                string ime = "";
                string prezime = "";
                string korisnicko = "";
                ...
                using (XmlReader reader = XmlReader.Create(@"C:\Users\Katarina\Desktop\Taxi\Taxi\Taxi\Taxi\korisnici.xml"))
                {
                    while (reader.Read())
                    {
            ...
            {
                string line;
                System.IO.StreamReader file = new System.IO.StreamReader(@"C:\Users\Katarina\Desktop\Taxi\Taxi\Taxi\Taxi\dispeceri.txt");
                ...
                string path = @"C:\Users\Katarina\Desktop\Taxi\Taxi\Taxi\Taxi\korisnici.xml";
        ...
        {
            if (File.Exists(@"C:\Users\Katarina\Desktop\Taxi\Taxi\Taxi\Taxi\voznje.xml"))
            {
                string datum = "";
                string pocetna = "";
                string krajnja = "";
                ...
                using (XmlReader reader = XmlReader.Create(@"C:\Users\Katarina\Desktop\Taxi\Taxi\Taxi\Taxi\voznje.xml"))
                {
                    while (reader.Read())
                    {
